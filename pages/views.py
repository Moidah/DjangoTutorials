...
class CartView(View):
    ...
    def post(self, request, product_id):
        # Obtener los productos del carrito de la sesión y añadir el nuevo producto
        cart_product_data = request.session.get('cart_product_data', {})
...
class CartRemoveAllView(View):
    # Método POST para eliminar todos los productos del carrito
    def post(self, request):
...
# the same application wihtout dependency inversion: 
